...
define('modules/Edition/src/EditionControllerInterface',[],function(){
...
define('utils/NoteUtils',['underscore'], function(_) {
...
define('modules/Edition/src/EditionModuleInterface',[],function(){
...
define('text!modules/MainMenu/src/MenuTabTemplate.html',[],function () { return '<ul class="menu-part nav-justified">\n\t{{#parts}}\n\t<li>\n\t\t<div>\n\t\t\t<ul class="item nav-justified">\n\t\t\t\t{{#items}}\n\t\t\t\t\t{{#file}}\n\t\t\t\t\t\t<li><input class="menu" type="file" id="importFile" accept="text/json, text/xml, .json, .xml" /></li>\n\t\t\t\t\t{{/file}}\n\t\t\t\t\t{{^file}}\n\t\t\t\t\t\t<li id="{{id}}" title="{{title}}">\n\t\t\t\t\t\t\t{{#text}}\n\t\t\t\t\t\t\t\t{{{text}}}\n\t\t\t\t\t\t\t{{/text}}\n\t\t\t\t\t\t\t{{#img}}\n\t\t\t\t\t\t\t\t<img src="{{imgPath}}{{img}}" alt="{{alt}}" />\n\t\t\t\t\t\t\t{{/img}}\n\t\t\t\t\t\t</li>\n\t\t\t\t\t{{/file}}\n\t\t\t\t{{/items}}\n\t\t\t</ul>\n\t\t\t<h5>{{name}}</h5>\n\t\t</div>\n\t</li>\n\t{{/parts}}\n</ul>\n';});
...
define('text!modules/FileEdition/src/FileEditionTemplate.html',[],function () { return '<div class="row" style="padding:15px 0 0 0;">\n\t<div id="file_edition_extra_elements_container" class="col-md-2 col-md-offset-3"></div>\n\t<div class="col-md-2">\n\t\t<input type="file" id="importFile" accept="text/json, text/xml, .json, .xml" /></li>\n\t\t<h5 class="text-center">Import</h5>\n\t</div>\n\t<div class="col-md-2">\n\t\t<div class="btn-group" role="group" aria-label="...">\n\t\t\t<button id="export_png" type="button" class="btn btn-default"><span class="glyphicon glyphicon-picture"></span> PNG</button>\n\t\t\t<button id="export_pdf" type="button" class="btn btn-default"><span class="glyphicon glyphicon-file"></span> PDF</button>\n\t\t\t<button id="export_musicCslJson" type="button" class="btn btn-default">MusicCSLJson</button>\n\t\t</div>\t\n\t</div>\n</div>';});
...
define('modules/LSViewer/src/BeamManager',['vexflow', 
...
define('modules/LSViewer/src/TupletManager',['vexflow','underscore'], function(Vex,_) {
	/**
...
define('modules/LSViewer/src/BarWidthManager',['modules/core/src/SongBarsIterator', 'modules/core/src/SectionBarsIterator', 'underscore'], function(SongBarsIterator, SectionBarsIterator, _) {
	/**
    * 
...
define('text!modules/MainMenu/src/MainMenuTemplate.html',[],function () { return '<div>\n\t<ul id="main_menu_first_level"  class="nav nav-tabs nav-justified">\n\t  \n\t</ul>\n\t<div id="main_menu_second_level">\n\t\t\n\t</div>\n</div>\n';});
...
define('text!utils/PopIn.html',[],function () { return '<div class="modal fade {{classTitle}}" tabindex="-1" role="dialog">\n  <div class="modal-dialog">\n    <div class="modal-content">\n      <div class="modal-header">\n        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>\n        <h4 class="modal-title">{{title}}</h4>\n      </div>\n      <div class="modal-body">\n        {{{content}}}\n      </div>\n      <div class="modal-footer">\n        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>\n        <button type="button" class="btn btn-primary modal_submit">{{footerButtonTitle}}</button>\n      </div>\n    </div>\n  </div>\n</div>';});
...
define('modules/Audio/src/AudioAnimation',['jquery'], function($){
	/**
...
define('modules/Edition/src/ClipboardManager',[
	'jquery',
	'utils/UserLog',
], function($, UserLog){
