define(['tests/songs/unfold/GertrudesBounce',
	'modules/Unfold/test/UnfoldTester'], function(GertrudesBounce, UnfoldTester){
	return function(assert){
		...
		unfoldTester.compareObject(startLabels.get('CODA2TO'), {
			section: 8,
			bar: 0,
			playIndex: 0
		}, 'Coda2To');
		...
		unfoldTester.compareObject(endLabels.get('Coda2'), {
			section: 0,
			bar: 5,
			playIndex: 0
		}, 'Coda2');
