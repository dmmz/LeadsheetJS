define([
	...
	SimilarityAnalysisController.prototype.initSubscribe = function() {
		var self = this;
		$.subscribe('SimilarityAnalysisView-compute', function(el, threshold, size, structure, strict) {
			self.computeSimilarityAnalysis(threshold, size, structure, strict);
		});
	...
	SimilarityAnalysisController.prototype.computeSimilarityAnalysis = function(threshold, size, structure, strict) {
		var self = this;
		var simAPI = new SimilarityAnalysisAPI();
